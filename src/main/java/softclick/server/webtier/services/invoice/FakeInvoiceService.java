...
public class FakeInvoiceService implements IInvoiceService {
    ...
    private final Client client1=new Client("abouzbiba","wafae","wafae.abouzbiba@gmail.com","06 37 94","soft","temara","maroc");
    private final Client client2=new Client("cccc","ccc","ccc","06 37 94","soft","temara","maroc");
